#
# Be sure to run `pod lib lint WATableViewAdapter.podspec' to ensure this is a
...
iOS tabelview does not provides the multi-level functionality. WATableViewAdapter provides this functionality. This library contains wrappers for UITableViewDatasource and UITableViewDelegate which provides functionality of multilevel tableview.
  ...
  s.author           = { 'wasimshigri' => 'wasimshigri@gmail.com' }
  s.source           = { :git => 'https://github.com/wasimshigri/WATableViewAdapter.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'

  s.source_files = 'WATableViewAdapter/Classes/**/*'

  
  # s.resource_bundles = {
  #   'WATableViewAdapter' => ['WATableViewAdapter/Assets/*.png']
  # }
